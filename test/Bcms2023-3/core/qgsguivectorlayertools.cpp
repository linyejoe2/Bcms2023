...
#include "bcmsapp.h"
#include "../maptools/qgsfeatureaction.h"
...
bool QgsGuiVectorLayerTools::stopEditing(QgsVectorLayer *layer,
    ...
    if (layer->isModified()) {
        ...
        switch (QMessageBox::question(
            ...
            case QMessageBox::Discard:
                BcmsApp::instance()->freezeCanvases();
                if (!layer->rollBack()) {
                    BcmsApp::instance()->messageBar()->pushMessage(
                ...
                BcmsApp::instance()->freezeCanvases(false);
    ...
    {
        BcmsApp::instance()->freezeCanvases(true);
        layer->rollBack();
        BcmsApp::instance()->freezeCanvases(false);
        res = true;
        layer->triggerRepaint();
...
void QgsGuiVectorLayerTools::commitError(QgsVectorLayer *vlayer) const {
    ...
    QgsMessageBarItem *errorMsg = new QgsMessageBarItem(
        ...
        BcmsApp::instance()->messageBar());
    BcmsApp::instance()->messageBar()->pushItem(errorMsg);
}
