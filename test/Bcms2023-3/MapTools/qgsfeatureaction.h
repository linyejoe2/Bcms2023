...
class QgsFeatureAction : public QAction {
   ...
   public slots:
     ...
     * dialog is opened
     *
     * \returns TRUE if feature was added if showModal is true. If showModal is
     * FALSE, returns TRUE in every case
     */
    bool addFeature(
        const QgsAttributeMap &defaultAttributes = QgsAttributeMap(),
        bool showModal = true, QgsExpressionContextScope *scope = nullptr,
